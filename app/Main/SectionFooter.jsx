    ...
    <section className="footer">
      <div className="footer-content">
        <div className="footer-content-left">
          <Image
            ...
            alt="Logo"
          />
          <h1 className="subheadline white">Shrey Dahiya</h1>
          <p className="description grey">
            10 years experience in Full Stack and Web3 development, UI/UX Building
      ...
      <div className="footer-content-bottom">
        <p className="small-description grey">
          © 2025 Shrey Dahiya All Rights Reserved
        </p>
        <div className="footer-socials">
          {/* <Linkedin strokeWidth={1.25} className="footer-socials-icon" /> */}
          <a href="https://www.linkedin.com/in/shrey-dahiya/" target="_blank">
            <svg
