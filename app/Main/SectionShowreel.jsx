        ...
        <div>
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col flex-1 gap-2">
                <h3 className="text-2xl font-medium leading-7 text-zinc-200">
                  Senior Software Engineer (NeuralSeek)
            ...
            >
              ...
              <div className="flex flex-col flex-1 gap-2">
                <h3 className="text-2xl font-medium leading-7 text-zinc-200">
                Senior Full-Stack Developer (Consumer Internet Labs LLC)
                  <span className="font-normal text-zinc-400 lg:hidden">
                    {" "}
                    - 2022
                  </span>
            ...
            >
              ...
              <div className="flex flex-col flex-1 gap-2">
                <h3 className="text-2xl font-medium leading-7 text-zinc-200">
                Backend / Full-Stack Developer (FieldClock LLC & Charter Schools USA)
                  <span className="font-normal text-zinc-400 lg:hidden">
                    {" "}
                    - 2021
                  </span>
